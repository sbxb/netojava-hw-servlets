...
echo -e "\n Try to edit the third post (already deleted)"
curl -i -X POST -H "Content-Type: application/json" -d '{"id":3,"content":"Third post edited"}' http://localhost:8080/api/posts
